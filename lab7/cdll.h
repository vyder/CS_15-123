...
/*  ------------------------------------------------------------------------------------------------------
	...
	bit messier. You msut be diligent to correctly modify the next pointer on the node behind
...
/*  ------------------------------------------------------------------------------------------------------
	...
	breif = 0 mode => print some
	full = 1 mode => print ALL!

	iterate through the list => print the data in breif mode
